...
//------------------------------------------------------用户体系	
	...
	public function __construct($options) {
		$this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : 'YXA6wavjwA1NEee9MA0hpcDY3Q';
		$this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : 'YXA6vQZKCr1jgoi6mJIJhFs32IBj98M';
		$this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : '1163170320178092';
		$this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : 'china hosp';
