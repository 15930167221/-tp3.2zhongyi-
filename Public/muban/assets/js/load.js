(function(e, t) {
	...
	function M(t, r) {
		...
		function s(t) {
			t = t || e.event;
			if (t.type === "load" || /loaded|complete/.test(o.readyState) && (!n.documentMode || n.documentMode < 9)) {
				o.onload = o.onreadystatechange = o.onerror = null;
				r()
			}
		}
	...
	var n = e.document,
		...
		s = {},
		o = {},
		u = "async" in n.createElement("script") || "MozAppearance" in n.documentElement.style || e.opera,
		a, f, l = e.head_conf && e.head_conf.head || "head",
		c = e[l] = e[l] ||
	function() {
