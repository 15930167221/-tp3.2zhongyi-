...
head.js("http://localhost/zySystem/Public/muban/assets/js/skin-select/jquery.cookie.js");
head.js("http://localhost/zySystem/Public/muban/assets/js/skin-select/skin-select.js");

//Showing Date
head.js("http://localhost/zySystem/Public/muban/assets/js/clock/date.js");

//Bootstrap
//head.js("assets/js/bootstrap.js");

//NEWS STICKER
head.js("http://localhost/zySystem/Public/muban/assets/js/newsticker/jquery.newsTicker.js", function() {
...
head.js("http://localhost/zySystem/Public/muban/assets/js/custom/scriptbreaker-multiple-accordion-1.js", function() {

    $(".topnav").accordionze({
        accordionze: true,
        speed: 500,
        closedSign: '<img src="http://localhost/zySystem/Public/muban/assets/img/plus.png">',
        openedSign: '<img src="http://localhost/zySystem/Public/muban/assets/img/minus.png">'
    });
...
head.js("http://localhost/zySystem/Public/muban/assets/js/slidebars/slidebars.min.js", "http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js", function() {
...
//EASY PIE CHART
head.js("http://localhost/zySystem/Public/muban/assets/js/gage/jquery.easypiechart.min.js", function() {
...
head.js("http://localhost/zySystem/Public/muban/assets/js/tip/jquery.tooltipster.js", function() {
